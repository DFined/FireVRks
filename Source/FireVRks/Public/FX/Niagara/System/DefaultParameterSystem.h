...
public:
	...
	BlockCompoundParameter DISTANCE_CORRECTION_SETTINGS = BlockCompoundParameter("Distance correction settings", false, true, true);
	FormalParameter<bool> USE_DISTANCE_CORRECTION = FormalParameter(DFType::TYPED_BOOL_PARAMETER, "Use distance correction", true, true, true);
	 ...
	 * MOTION SETTINGS 
	 */
	BlockCompoundParameter MOTION_SETTINGS_BLOCK = BlockCompoundParameter("Motion settings", true, true, false);
	EnumFormalParameter MOTION_TYPE = EnumFormalParameter("Motion type", true, &EnumLike::MOTION_TYPE, true);
	FormalParameter<float> MOTION_START_DELAY = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Start delay", true, 0.0, true);
	
	BlockCompoundParameter FISH_MOTION_BLOCK = BlockCompoundParameter("Fish motion", true, true, true);
	FormalParameter<float> MOTION_FISH_FREQUENCY = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Frequency", true, 80.0, true);
	FormalParameter<float> MOTION_FISH_AMPLITUDE = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Amplitude", true, 100.0, true);
	
	
	BlockCompoundParameter BEES_MOTION_BLOCK = BlockCompoundParameter("Bees motion", true, true, true);
	FormalParameter<float> MOTION_BEES_ROTATION = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Rotation rate", true, 30.0, true);
	FormalParameter<float> MOTION_BEES_SPEED = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Speed", true, 3000.0, true);

	
	BlockCompoundParameter WHEELS_MOTION_BLOCK = BlockCompoundParameter("Wheels motion", true, true, true);
	FormalParameter<float> MOTION_WHEELS_ROTATION = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Rotation rate", true, 30.0, true);
	FormalParameter<float> MOTION_WHEELS_SPEED = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Speed", true, 3000.0, true);
	FormalParameter<float> MOTION_WHEELS_EJECTION_SPEED = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Trail ejection speed", false, 3, true);
	

	BlockCompoundParameter SPIRAL_MOTION_BLOCK = BlockCompoundParameter("Spiral motion", true, true, true);
	FormalParameter<float> MOTION_SPIRALS_ROTATION = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Rotation rate", true, 30.0, true);
	FormalParameter<float> MOTION_SPIRALS_EJECTION_SPEED = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Size", false, 3.0, true);

	BlockCompoundParameter ADVANCED_MOTION_BLOCK = BlockCompoundParameter("Advanced motion", true, true, true);
	FormalParameter<float> MOTION_ROLL_MIN_ROTATION = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Roll min rotation rate", true, 30.0, true);
	FormalParameter<float> MOTION_ROLL_MAX_ROTATION = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Roll max rotation rate", true, 60.0, true);
	FormalParameter<float> MOTION_PITCH_MIN_ROTATION = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Pitch min rotation rate", true, 30.0, true);
	FormalParameter<float> MOTION_PITCH_MAX_ROTATION = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Pitch max rotation rate", true, 60.0, true);
	FormalParameter<float> MOTION_YAW_ROTATION = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Yaw rotation rate", true, 60.0, true);
	FormalParameter<float> MOTION_NORMAL_THRUST = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Normal thrust", true, 10000.0, true);
	FormalParameter<float> MOTION_NORMAL_FREQUENCY = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Normal motion frequency", true, 120, true);
	FormalParameter<float> MOTION_FORWARD_THRUST = FormalParameter<float>(DFType::TYPED_FLOAT_PARAMETER, "Forward thrust", true, 5000, true);
	...
	CompoundableFormalParameter<float> CRACKLE_TRAIL_LIFETIME =
		CompoundableFormalParameter("Crackle trail lifetime", DFType::TYPED_FLOAT_PARAMETER, true, 0.6f);
	...
	FormalParameter<float> CRACKLE_TRAIL_EMISSION_DURATION =
		FormalParameter(DFType::TYPED_FLOAT_PARAMETER, "Crackle Trail Emission Duration", true, 3.0f, true);
	...
	CompoundableFormalParameter<float> WILLOW_TRAIL_LIFETIME = CompoundableFormalParameter("Willow trail lifetime", DFType::TYPED_FLOAT_PARAMETER, true, 3.0f,
	                                                                                       4.0f);
